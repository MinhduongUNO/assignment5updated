...
class Organization(models.Model):
    Org_ID = models.CharField(blank=False, null=False, unique=True, max_length=10)
...
class Event(models.Model):
    Event_ID = models.CharField(blank=False, null=False, unique=True, max_length=10)
...
class EmpRecord(models.Model):
    ...
    EmpRecord_Time = models.DecimalField(decimal_places=2, max_digits=4)

    def created(self):
        self.save()

    def __str__(self):
        return str(self.username, self.Event_ID, self.EmpRecord_Time)
